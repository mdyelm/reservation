...
function FlatpickrInstance(element, config) {
    ...
    function createNumberInput(inputClassName) {
        ...
        yearLabel = createElement("strong", "test", '年');
        numInput.type = "text";
        numInput.pattern = "\\d*";
    ...
    function changeMonth(value, is_offset, animate) {
        ...
        self.currentMonthElement = self.navigationCurrentMonth.lastChild;
        self.currentYearElement = self.navigationCurrentMonth.firstChild.childNodes[0];
