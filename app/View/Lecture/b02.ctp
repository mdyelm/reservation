...
<div class="inner">
	...
	<div class="contact-inner">
		<!--<h2>アカウント情報</h2>-->
		<form action="<?=$this->webroot?>lecture/B03<?php if( isset($from) ){ echo '/?from=' . $from; } ?>" id="formB02" method="post">
			<div class="form-row">
			...
			<div class="form-row text-center accept">
				<label>
			...
			<div class="form-row text-center">
				<input type="submit" value="送信する" class="btnSubmit w260">
			</div>
		</form>
		<div class="info">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			var validator = $("#formB02").validate({
				rules: {
